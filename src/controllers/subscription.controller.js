...
// ek channel ko kon kon user subscribe kiya hai
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, subscriptions[0], "All user channel Subscribes fetched successfull!!"))
})

// controller to return channel list to which user has subscribed
// ek user ka subscribed list 
const getSubscribedChannels = asyncHandler(async (req, res) => {
    ...
    const subscriptions = await Subscription.aggregate([
        {
            // in this case i am a subscriber i want to find channel id so 
            $match: {
